...
"[project]/src/app/api/admin/active-users/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findMany({
            include: {
                tickets: {
                    select: {
                        id: true,
        ...
        const seatAllocations = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].seat.findMany({
            where: {
                status: "BOOKED",
                allocatedUserId: {
                    not: null
...
//# sourceMappingURL=%5Broot-of-the-server%5D__48df87e3._.js.map