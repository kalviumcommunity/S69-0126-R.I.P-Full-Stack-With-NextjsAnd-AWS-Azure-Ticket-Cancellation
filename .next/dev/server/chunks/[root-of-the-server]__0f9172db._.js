...
const signRefreshToken = async (payload)=>{
    return await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$sign$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SignJWT"](payload).setProtectedHeader({
        alg: "HS256"
    }).setExpirationTime("7d").sign(new TextEncoder().encode(getJWTSecret()));
};
...
"[project]/src/app/api/admin/buses/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, props) {
    ...
    try {
        ...
        if (!busNumber || !totalSeats) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "Bus number and total seats are required"
            }, {
                status: 400
            });
        }
        ...
        const bus = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bus.update({
            where: {
...
async function DELETE(request, props) {
    ...
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bus.delete({
            where: {
                id: parseInt(params.id)
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0f9172db._.js.map