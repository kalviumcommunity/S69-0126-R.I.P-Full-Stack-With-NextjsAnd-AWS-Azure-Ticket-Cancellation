module.exports = [
  ...
  (e) => {
    ...
    var eg =
      ...
      em =
        ...
        v);
    function eb() {}
    (e.s(["CachedRouteKind", () => eg, "IncrementalCacheKind", () => em], 220),
  ...
  `);
          ...
          serverModuleMap: new Proxy(
            {},
            {
              get: (e, t) => {
                ...
                if (
                  !(i = s
                    ? o[ej((a = s.page), "app") ? a : "app" + a]
                    : Object.values(o).at(0))
                )
                  return;
                let { moduleId: c, async: u } = i;
                return { id: c, name: t, chunks: [], async: u };
              },
            }
          ),
        };
    ...
    (e.s(["NodeNextRequest", () => tu, "NodeNextResponse", () => tl], 16795),
      e.s(["getRevalidateReason", () => td], 47587),
      e.s(["sendResponse", () => tp], 66012),
      e.s(["getCacheControlHeader", () => th], 26937));
  },
  47114,
  (e, t, r) => {
    "use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f408c708._.js.map
