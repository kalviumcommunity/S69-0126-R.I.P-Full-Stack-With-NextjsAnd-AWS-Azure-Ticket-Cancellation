      ...
      let S = A.method || "GET",
        ...
        F = {
          ...
          renderOpts: {
            ...
            onInstrumentationRequestError: (w, D, P, e) =>
              M.onRequestError(A, w, P, e, v),
          },
          sharedContext: { buildId: E },
        },
        x = new n.NodeNextRequest(A),
        K = new n.NodeNextResponse(w),
        k = o.NextRequestAdapter.fromNodeNextRequest(
          x,
          (0, o.signalFromNodeResponse)(w)
        );
      try {
        let r = async (A) =>
          ...
          n = async (e) => {
            ...
            if (!j) return null;
            if (
              (null == a || null == (t = a.value) ? void 0 : t.kind) !==
            ...
            return (
              ...
              !a.cacheControl ||
                ...
                C.set(
                  "Cache-Control",
                  (0, l.getCacheControlHeader)(a.cacheControl)
                ),
              await (0, B.sendResponse)(
                x,
                K,
        ...
        if (
          ...
          throw w;
        return (
          await (0, B.sendResponse)(x, K, new Response(null, { status: 500 })),
          null
        );
      }
    }
